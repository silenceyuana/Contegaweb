...
CREATE TABLE public.player_sessions (
  ...
  CONSTRAINT player_sessions_player_id_fkey FOREIGN KEY (player_id) 
...
CREATE OR REPLACE FUNCTION start_player_session(p_id bigint, p_name text)
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER AS $$
BEGIN
  INSERT INTO public.player_sessions (player_id, player_name)
  VALUES (p_id, p_name);
END;
$$;


CREATE OR REPLACE FUNCTION end_player_session(session_id_to_end bigint)
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER AS $$
BEGIN
...
('BetterMachao', '$2a$12$uGhNVwDho2mK8YD.buFMNuDQOwaXasNjMJG4cp5DqnM7EXj.RSNWC');
